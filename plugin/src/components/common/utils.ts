...
import {
    ...
    CHART_THEME_DARK,
    CHART_THEME_DEFAULT,
    CHART_THEME_ESSOS, CHART_THEME_HALLOWEEN,
    CHART_THEME_INFOGRAPHIC,
    CHART_THEME_MACARONS,
    CHART_THEME_PURPLE_PASSION,
    CHART_THEME_ROMA,
    CHART_THEME_SHINE,
    CHART_THEME_VINTAGE,
    CHART_THEME_WALDEN,
    CHART_THEME_WESTEROS,
    CHART_THEME_WONDERLAND,
} from '../../common/themes';
import { ChartThemeType } from '../../types/enum/chart-theme-types.ts';

export const getTheme = (themeName: string) => {
    let t: any = CHART_THEME_DEFAULT.theme;
    switch (themeName) {
        case ChartThemeType.DEFAULT:{
            t = CHART_THEME_DEFAULT.theme;
            break;
        }
        case ChartThemeType.VINTAGE:{
            t = CHART_THEME_VINTAGE.theme;
            break;
        }
        case ChartThemeType.DARK:{
            t = CHART_THEME_DARK.theme;
            break;
        }
        case ChartThemeType.WESTEROS:{
            t = CHART_THEME_WESTEROS.theme;
            break;
        }
        case ChartThemeType.ESSOS:{
            t = CHART_THEME_ESSOS.theme;
            break;
        }
        case ChartThemeType.WONDERLAND:{
            t = CHART_THEME_WONDERLAND.theme;
            break;
        }
        case ChartThemeType.WALDEN:{
            t = CHART_THEME_WALDEN.theme;
            break;
        }
        case ChartThemeType.CHALK:{
            t = CHART_THEME_CHALK.theme;
            break;
        }
        case ChartThemeType.INFOGRAPHIC:{
            t = CHART_THEME_INFOGRAPHIC.theme;
            break;
        }
        case ChartThemeType.MACARONS:{
            t = CHART_THEME_MACARONS.theme;
            break;
        }
        case ChartThemeType.ROMA:{
            t = CHART_THEME_ROMA.theme;
            break;
        }
        case ChartThemeType.SHINE:{
            t = CHART_THEME_SHINE.theme;
            break;
        }
        case ChartThemeType.PURPLE_PASSION:{
            t = CHART_THEME_PURPLE_PASSION.theme;
            break;
        }
        case ChartThemeType.HALLOWEEN:{
            t = CHART_THEME_HALLOWEEN.theme;
            break;
        }
    }
